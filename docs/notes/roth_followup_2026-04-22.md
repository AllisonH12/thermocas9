...
**Framework.** Code/results at `memo-2026-04-22-as` of <https://github.com/AllisonH12/thermocas9>.
...
- **Revision checkpoint**: if this note sits more than 48 h before sending, re-verify the tag reference (`git rev-parse memo-2026-04-22-as` should still resolve).
