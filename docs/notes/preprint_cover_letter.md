...
Benchmarks, positives lists, scored JSONLs, figures, and tests are all committed at the immutable tag `memo-2026-04-22-b`; 229 unit tests pass.
...
- **Tag-reference check before submission**: `git rev-parse memo-2026-04-22-b` must still resolve, and the PAPER.md citation must still read `memo-2026-04-22-b`. Do not let development on `main` implicitly move the reference.
