...
**Status.** Open educational research framework. Not peer-reviewed. Not a clinical decision-support system. Hypothesis generation only — no claim of prospective wet-lab validation absent the editing study described in [§6.3 / §6.5 / `external_validation_instruction.md`](https://github.com/AllisonH12/thermocas9/blob/memo-2026-04-22-bx/docs/notes/external_validation_instruction.md).
...
- **`MANUSCRIPT.pdf`** — *Bioinformatics*-submission-shaped short version. Cite tag `memo-2026-04-22-bx`. [Download PDF](https://github.com/AllisonH12/thermocas9/blob/memo-2026-04-22-bx/MANUSCRIPT.pdf).
...
For the *Bioinformatics*-shaped short version, cite `memo-2026-04-22-bx` instead.
