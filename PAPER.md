...
**Date.** 2026-04-22.
**Code.** <https://github.com/AllisonH12/thermocas9> at tag `memo-2026-04-22-bk` (immutable pointer to the exact revision that produced this paper).
...
- **Code**: <https://github.com/AllisonH12/thermocas9>. Cite tag **`memo-2026-04-22-bk`** for this document. 245 tests pass under `uv run pytest -q`.
