...
Code at <https://github.com/AllisonH12/thermocas9>, immutable tag `memo-2026-04-22-ab`.
...
**Availability and implementation.** `thermocas` is open source at <https://github.com/AllisonH12/thermocas9>, tagged `memo-2026-04-22-ab` for the version evaluated here. 236 unit tests pass under `uv run pytest -q`. Python 3.11+, BSD-3.
...
From a fresh clone of the repository at `memo-2026-04-22-ab`:
